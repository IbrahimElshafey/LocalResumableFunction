...
namespace ResumableFunctions.Handler.DataAccess.Abstraction
{
    public interface IWaitTemplatesRepo
    {
        Task<WaitTemplate> AddNewTemplate(
            ExpressionsHashCalculator hashResult, object currentFunctionInstance, int funcId, int groupId, int methodId);
        ...
        Task<List<WaitTemplate>> GetWaitTemplates(int methodGroupId,int functionId);
